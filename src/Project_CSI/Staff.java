...
// 리스트 5.5 : Staff.java
// Staff 클래스는 Employee 클래스를 상속받는데 Employee 클래스의 멤버 변수와 멤버 메소드 
// 를 가지고 있으며 Employee 클래스의 슈퍼 클래스의 멤버 변수와 멤버 메소드를 가지고 있다. 
// 또한 새로운 변수(department)를 정의하고 그 변수에 접근 가능한 메소드가 있다.
